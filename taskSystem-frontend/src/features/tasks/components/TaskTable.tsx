...
export function TaskTable({ tasks, onMove, onOpen }: TaskTableProps) {
                    ...
                    {tasks.map((task) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <td className="whitespace-nowrap px-4 py-3">
                                    <span className={overdue ? "font-medium text-danger" : dueToday ? "font-medium text-priority-high" : "text-ink-soft"}>
